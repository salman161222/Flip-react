...
import FrameComponent2 from "../components/common/Sidebar";
      ...
      <main className={styles.frameParent}>
        ...
        <section className={styles.frameDateBetPM}>
          <div className={styles.divUserFrameBetAmount}>
              ...
              <div className={styles.rectangleArsenalvsChelseaTh1}>
                <div className={styles.groupedFramesParent}>
                  ...
                  <div className={styles.multiLevelFrames}>
                    <div className={styles.previousRolls}>Previous rolls</div>
                    <img
                ...
                <img className={styles.coinIcon6} alt="" src="/coin-6.svg" />
                <img className={styles.coinIcon7} alt="" src="/coin-7.svg" />
                <img className={styles.coinIcon8} alt="" src="/coin-8.svg" />
                <img className={styles.coinIcon9} alt="" src="/coin-9.svg" />
            ...
            <div className={styles.framedsvg}>
              ...
              <div className={styles.userBetFrame}>
                <div className={styles.xPMRow}>
                  ...
                  <div className={styles.resultRow}>
                    <div className={styles.arsenalAliciaChelseaFrame}>
                      <div className={styles.betsTotal}>17 Bets Total</div>
                    ...
                    <div className={styles.dukajFrnkfrtChildParent}>
                      <div className={styles.dukajFrnkfrtChild}>
                        ...
                        <div className={styles.primaryUserData}>40.00</div>
                      </div>
                      ...
                      <div className={styles.subheaderText}>
                        ...
                        <div className={styles.frameWithPayout}>20.00</div>
                      </div>
                      <div className={styles.multiplicationDiv}>
                        <div className={styles.userTextCell}>
                          ...
                          <div className={styles.morrriez}>Morrriez</div>
                        </div>
                      ...
                      <div className={styles.primaryFrames}>
                        <div className={styles.beauFontFrames}>
                          ...
                          <div className={styles.frnkfrt2324}>Frnkfrt2324</div>
                        </div>
                      ...
                      <div className={styles.dukajFrnkfrtChild1}>
                        <div className={styles.ellipseParent}>
                          ...
                          <div className={styles.pudgyPalh}>PUDGY PALH</div>
                        </div>
                ...
                <div className={styles.xPMRow1}>
                  ...
                  <div className={styles.frameParent8}>
                    <div className={styles.betsTotalParent}>
                      <div className={styles.betsTotal1}>17 Bets Total</div>
                    ...
                    <div className={styles.frameParent9}>
                      ...
                      <div className={styles.frameParent13}>
                        <div className={styles.ellipseParent2}>
                          ...
                          <div className={styles.morrriez1}>Morrriez</div>
                        </div>
                      ...
                      <div className={styles.frameParent16}>
                        <div className={styles.ellipseParent5}>
                          ...
                          <div className={styles.frnkfrt23241}>Frnkfrt2324</div>
                        </div>
                      ...
                      <div className={styles.frameParent18}>
                        <div className={styles.ellipseParent7}>
                          ...
                          <div className={styles.pudgyPalh1}>PUDGY PALH</div>
                        </div>
                ...
                <div className={styles.xPMRow2}>
                  ...
                  <div className={styles.frameParent21}>
                    <div className={styles.betsTotalGroup}>
                      <div className={styles.betsTotal2}>17 Bets Total</div>
                    ...
                    <div className={styles.frameParent22}>
                      ...
                      <div className={styles.frameParent26}>
                        <div className={styles.ellipseParent12}>
                          ...
                          <div className={styles.morrriez2}>Morrriez</div>
                        </div>
                      ...
                      <div className={styles.frameParent27}>
                        <div className={styles.ellipseParent13}>
                          ...
                          <div className={styles.frnkfrt23242}>Frnkfrt2324</div>
                        </div>
                      ...
                      <div className={styles.frameParent31}>
                        <div className={styles.ellipseParent17}>
                          ...
                          <div className={styles.pudgyPalh2}>PUDGY PALH</div>
                        </div>
